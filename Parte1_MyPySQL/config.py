...
def insertar_registros():
    ...
    try:
        with conexion.cursor() as cursor:
            # Insertar un usuario
            cursor.execute("INSERT INTO usuarios (nombre, password, email) VALUES ('Adriana Pérez', 'password123', 'adriana@example.com')")
            id_usuario = cursor.lastrowid
            
            # Insertar una película
            cursor.execute("INSERT INTO peliculas (nombre, genero, duracion) VALUES ('Saw', 'Terror', 150)")
...
if __name__ == "__main__":
    ...
    cambiar_genero_pelicula('Saw', 'Suspenso')
